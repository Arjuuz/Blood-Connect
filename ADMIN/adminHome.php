        ...
        <nav class="navbar navbar-expand-lg stroke">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mx-lg-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="hospitalRequest.php">Verify Hospital</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="donorRequest.php">Verify Donor</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="viewHospital.php">Hospitals</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="viewDonor.php">Donors</a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="userRequest.php">User Requests</a>
              </li>
    ...
    <div class="w3l-banner-content">
      <div class="container">
        <div class="bannerhny-info text-center">
          ...
          <h3 class="">Every Blood Donor. is A Life Saver.</h3>
